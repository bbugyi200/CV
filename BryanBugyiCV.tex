...
\begin{itemize}
\item \ressubheading{localalias}{Python, Unix Shell}{Create per-directory local aliases in zsh!}{2017 - Current}
\item \ressubheading{ProtectMyLaptop}{Python, Unix Shell}{Security Monitoring Program for your Laptop}{2017 - Current}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
\item {\bf Development:} Python (preferred), C/C++, Unix Shell, Haskell
