...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\resheading{Open Source Projects {\mdseries(github.com/bbugyi200)}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{itemize}
\item \ressubheading{cookie}{Shell}{A Template-based File Generator.}{2017 - Current}
\item \ressubheading{funky}{Python, Shell}{Create per-directory local aliases in zsh!}{2017 - Current}
\item \ressubheading{ProtectMyLaptop}{Python, Shell}{Security Monitoring Program for your Laptop}{2017 - Current}
\item \ressubheading{SlackRU}{Python, SQL}{Slackbot used for Rutgers HackRU Hackathon \mdseries{(github.com/HackRU)}}{2017 - 2018}
