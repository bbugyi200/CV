...
\begin{itemize}
    \item
    \ressubheading{Google}{Manhattan, NY}{Software Engineer}{June 2022 - Current} \vspace{8pt}

        Supporting Google Ad Manager on a full stack team working working on
        Java on the backend and Dart[1] \slash AngularDart[2] \slash Sass[3] on
        the frontend. \vspace{6pt}

        
        [1]: https://dart.dev/guides

        [2]: https://angulardart.xyz/guide

        [3]: https://sass-lang.com

    \item
    \ressubheading{Bloomberg L.P.}{Manhattan, NY}{Site Reliability Engineer (SRE) / Senior Software Engineer}{January 2021 - May 2022} \vspace{8pt}
