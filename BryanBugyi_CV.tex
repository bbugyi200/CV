...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item My favorite courses in college were ``Systems Programming'' and ``Operating Systems'', both of which well prepared me for programming in a Unix environment.
    \end{itemize}
