...
\item
	...
	\begin{itemize}
            ...
            \resitem{Tracked and reported network outages using Jira ticketing system.}
            \resitem{Wrote Python scripts to automate frequent department tasks (e.g. parsing spreadsheets, opening/closing Jira tickets).} 
	\end{itemize}
\end{itemize}
