...
\begin{itemize}
    ...
    \sub{Languages}\\
        To indicate my level of proficiency with each programming language I am at least somewhat familiar with, I have used ``lines-of-code ($LoC$) written'' as my key metric in the table below:
        ...
        \declarecommand{\E}{}{$150,000$}

        \ssub{Programming Languages}\vspace{-0.5cm}
        \begin{multicols}{3}
